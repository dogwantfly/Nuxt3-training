      ...
      >
        <ClientOnly>
          <swiper-container
            ...
            :loop="true"
            style="--swiper-theme-color: #BF9D7D;"
          >
    ...
    <section class="delicacy position-relative py-20 py-md-30 bg-primary-10">
      <div class="container">
        ...
        <div class="row flex-nowrap overflow-x-auto">
          <div class="col-10 col-md-6 col-xl-4" v-for="culinaryItem in culinary" :key="culinaryItem._id">
            <div class="card position-relative border-0 rounded-3">
              <picture>
                <source
                  :srcset="culinaryItem.image"
                  media="(min-width: 576px)"
                />
                <img
                  class="w-100 rounded-3"
                  :src="culinaryItem.image_sm"
              ...
              >
                ...
                >
                  <h5 class="card-title mb-0 fw-bold">{{ culinaryItem.title }}</h5>
                  <div
                    class="d-flex justify-content-between gap-4 text-neutral-40 fs-8 fs-md-7"
                  >
                    <span class="fw-bold">{{ culinaryItem.diningTime }}</span>
                  </div>
                </div>
